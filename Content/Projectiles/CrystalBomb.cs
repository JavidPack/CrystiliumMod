	...
	public class CrystalBomb : ModProjectile
	{
		...
		public override void Kill(int timeLeft)
		{
			...
			for (int h = 0; h < 20; h++)
			{
				...
				vel *= 5f;
				Projectile.NewProjectile(Projectile.GetSource_Death(), Projectile.Center.X, Projectile.Center.Y + 20, vel.X, vel.Y, Mod.Find<ModProjectile>("Shatter" + (1 + Main.rand.Next(0, 3))).Type, Projectile.damage - 8, 0, Projectile.owner);
			}
		}
