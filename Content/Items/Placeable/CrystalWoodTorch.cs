...
namespace CrystiliumMod.Content.Items.Placeable
{
	public class CrystalWoodTorch : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.createTile = ModContent.TileType<Tiles.CrystalWoodTorch>();
			Item.flame = true;
			Item.value = 50;
		}
		...
		public override void HoldItem(Player player)
		{
			...
			{
				Dust.NewDust(new Vector2(player.itemLocation.X + 16f * player.direction, player.itemLocation.Y - 14f * player.gravDir), 4, 4, ModContent.DustType<Dusts.Sparkle>());
			}
