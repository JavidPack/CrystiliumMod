...
namespace CrystiliumMod.Content.Items.Weapons
{
	internal class TrueRubyStaff : ModItem
	{
		...
		public override void SetDefaults()
		{
			...
			Item.shoot = ModContent.ProjectileType<Projectiles.TrueRubyProjectile>(); //What the item shoots, retains an int value | *
		...
		public override void AddRecipes()
		{
			...
			recipe.AddIngredient(ModContent.ItemType<Items.Weapons.EnchantedRubyStaff>());
