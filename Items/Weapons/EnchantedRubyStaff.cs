...
namespace CrystiliumMod.Items.Weapons
{
    public class EnchantedRubyStaff : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.value = 30000;
            item.rare = 3;
            item.shoot = mod.ProjectileType("FireGem"); //What the item shoots, retains an int value | *
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
            ...
            Projectile.NewProjectile(position.X-player.width/2, position.Y-player.height/2, speedX, speedY, mod.ProjectileType("FireGem"), damage, knockBack, player.whoAmI, 0f, 0f);
            return false;
        }
    }
}