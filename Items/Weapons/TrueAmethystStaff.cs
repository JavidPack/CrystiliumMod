...
namespace CrystiliumMod.Items.Weapons
{
    public class TrueAmethystStaff : ModItem
    {
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("TrueAmethystProjectile"); //What the item shoots, retains an int value
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod.ItemType("EnchantedAmethystStaff"), 1);
