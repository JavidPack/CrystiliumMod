...
namespace CrystiliumMod.Items.Weapons
{
    public class TrueTopazStaff : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.shoot = mod.ProjectileType("SapphirePortal");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(mod.ItemType("EnchantedTopazStaff"), 1);
        ...
        Vector2 mouse = new Vector2(Main.mouseX, Main.mouseY) + Main.screenPosition;
            ...
            Projectile.NewProjectile(DistX, DistY, Main.rand.Next(-10, 10), Main.rand.Next(-10, 10), mod.ProjectileType("SandParticle"), damage, knockBack, player.whoAmI, 0f, 0f);
            return false;
